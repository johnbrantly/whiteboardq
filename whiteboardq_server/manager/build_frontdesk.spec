...
"""PyInstaller spec file for WhiteboardQ FrontDesk Manager."""
...
a = Analysis(
    [str(SPEC_DIR / 'main_frontdesk.py')],
    ...
    datas=[
        ...
        # Tray icons (red/yellow/green for status)
        (str(PROJECT_ROOT / 'whiteboardq_server' / 'resources' / 'tray_red.ico'), 'whiteboardq_server/resources'),
        (str(PROJECT_ROOT / 'whiteboardq_server' / 'resources' / 'tray_yellow.ico'), 'whiteboardq_server/resources'),
        (str(PROJECT_ROOT / 'whiteboardq_server' / 'resources' / 'tray_green.ico'), 'whiteboardq_server/resources'),
    ...
    hiddenimports=[
        ...
        'whiteboardq_server.manager.tray',
        'whiteboardq_server.manager.tray.tray_manager',
        'whiteboardq_server.manager.tray.server_controller',
        'whiteboardq_server.manager.tray.icons',
